      ...
      <header className={`fixed top-0 inset-x-0 z-40 transition-all duration-500 ${navClass}`}>
        <Container size="wide" className="flex items-center justify-between h-[72px] md:h-[84px]">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href="tel:+77780301707" className={`flex items-center gap-2 text-[14px] font-medium tracking-tight ${wantsDark ? 'text-white' : 'text-ink-900'}`}>
              <Icons.Phone size={16} />
              <span>+7 (778) 030-17-07</span>
            </a>
    ...
    >
      ...
      <div className={`absolute top-[72px] inset-x-4 rounded-3xl bg-white shadow-soft-lg p-6 transition-all duration-500
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          <Button href="tel:+77780301707" as="a" variant="outline" size="md" icon={<Icons.Phone size={15}/>} iconAfter={null}>Позвонить</Button>
        </div>
        <div className="mt-5 pt-5 border-t border-ink-100 grid grid-cols-2 gap-3 text-[13px] text-ink-500">
          <a href="https://wa.me/77780301707" className="flex items-center gap-2 hover:text-ink-900">
        ...
        <div className="grid lg:grid-cols-12 gap-10 pb-20 border-b border-white/10">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={160} className="mt-7 flex flex-wrap gap-3">
              ...
              <Button href="https://wa.me/77780301707" as="a" variant="whatsapp" size="lg" icon={<Icons.WhatsApp size={17}/>} iconAfter={null}>WhatsApp</Button>
            </Reveal>
          </div>
          <div className="lg:col-span-5 lg:pl-8 lg:border-l border-white/10 flex flex-col justify-end">
            <Reveal delay={200}>
              <div className="space-y-5">
                ...
                <FooterContact icon={<Icons.Phone size={18}/>}   label="Телефон" value="+7 (778) 030-17-07" href="tel:+77780301707"/>
        ...
        <div className="grid md:grid-cols-12 gap-10 pt-14 pb-14">
          <div className="md:col-span-5">
            ...
            <div className="mt-7 flex gap-3">
              <SocialLink href="https://wa.me/77780301707"     icon={<Icons.WhatsApp size={17}/>}/>
              <SocialLink href="https://instagram.com"          icon={<Icons.Instagram size={17}/>}/>
              <SocialLink href="tel:+77780301707"               icon={<Icons.Phone size={17}/>}/>
