      ...
      <header className={`fixed top-0 inset-x-0 z-40 transition-all duration-500 ${navClass}`}>
        <Container size="wide" className="flex items-center justify-between h-[72px] md:h-[84px]">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href="tel:+77022749363" className={`flex items-center gap-2 text-[14px] font-medium tracking-tight ${wantsDark ? 'text-white' : 'text-ink-900'}`}>
              <Icons.Phone size={16} />
              <span>+7 702 274 93 63</span>
            </a>
    ...
    >
      ...
      <div className={`absolute top-[72px] inset-x-4 rounded-3xl bg-white shadow-soft-lg p-6 transition-all duration-500
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          <Button href="tel:+77022749363" as="a" variant="outline" size="md" icon={<Icons.Phone size={15}/>} iconAfter={null}>Қоңырау</Button>
        </div>
        <div className="mt-5 pt-5 border-t border-ink-100 grid grid-cols-2 gap-3 text-[13px] text-ink-500">
          <a href="https://wa.me/77022749363" className="flex items-center gap-2 hover:text-ink-900">
            <Icons.WhatsApp size={15}/> WhatsApp
          </a>
          <a href="https://www.instagram.com/manas_stroi_aktau/" className="flex items-center gap-2 hover:text-ink-900">
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={80}>
              <h2 className="display text-[clamp(40px,5.8vw,76px)] font-medium leading-[0.95] tracking-tightest">
                Фасадыңызды<br/>талқылауға <span className="text-gold-light italic font-light">дайынмыз</span>
              </h2>
            </Reveal>
          ...
          <div className="lg:col-span-5 lg:pl-8 lg:border-l border-white/10 flex flex-col justify-end">
            <Reveal delay={200}>
              <div className="space-y-5">
                <FooterContact icon={<Icons.MapPin size={18}/>}  label="Мекенжай"        value="г. Ақтау, ул. Промышленная зона 9, 8/1" />
                <FooterContact icon={<Icons.Phone size={18}/>}   label="Телефон"          value="+7 702 274 93 63" href="tel:+77022749363"/>
                <FooterContact icon={<Icons.Mail size={18}/>}    label="Пошта"            value="info@manasstroi.kz" href="mailto:info@manasstroi.kz"/>
                <FooterContact icon={<Icons.Clock size={18}/>}   label="Жұмыс уақыты"    value="Дс–Сб 09:00 — 18:00" />
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-10 pt-14 pb-14">
          <div className="md:col-span-5">
            ...
            <p className="mt-6 max-w-md text-[14.5px] text-white/60 leading-[1.7]">
              Ақтауда 2018 жылдан бастап премиум фасадтық жүйелерді өндіру және орнату.
              Сәулеттік сапа, бір жыл кепілдік, өз өндірістік алаңы.
            </p>
            <div className="mt-7 flex gap-3">
              <SocialLink href="https://wa.me/77022749363"     icon={<Icons.WhatsApp size={17}/>}/>
              <SocialLink href="https://www.instagram.com/manas_stroi_aktau/"          icon={<Icons.Instagram size={17}/>}/>
              <SocialLink href="tel:+77022749363"               icon={<Icons.Phone size={17}/>}/>
          ...
          <FooterCol title="Каталог" items={[
            ...
            { label: 'Сәндік панельдер',  onClick: () => navigate('catalog') },
          ...
          <FooterCol title="Сервис" items={[
            ...
            { label: 'Кеңес алу',       onClick: onOpenConsult },
