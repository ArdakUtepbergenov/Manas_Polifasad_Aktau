        ...
        <div className="max-w-[1200px]">
          ...
          <Reveal delay={180}>
            <p className="mt-8 max-w-xl text-[17px] md:text-[19px] leading-[1.55] text-white/75">
              Производим и монтируем премиальные фасадные системы для частных домов, коттеджей, ресторанов и коммерческих зданий в Ақтау. Архитектурное качество, гарантия год.
            </p>
          </Reveal>
          <Reveal delay={260}>
    ...
    <Section className="py-28 md:py-40">
      <Container size="wide">
        <SectionHeader
          ...
          lead="Каждый объект — индивидуальное проектное решение. Ниже несколько работ последних лет в Ақтау."
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={80}>
              <h2 className="display text-[clamp(34px,5vw,64px)] font-medium leading-[0.98] tracking-tightest">
                5000+ фасадов<br/>по всему Ақтау
              </h2>
            </Reveal>
          </div>
