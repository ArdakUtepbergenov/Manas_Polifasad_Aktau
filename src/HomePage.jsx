      ...
      <Container size="wide" className="relative h-screen min-h-[760px] flex flex-col justify-between pt-32 pb-12">
        <div className="flex items-center justify-between text-[12px] font-mono tracking-[0.18em] uppercase text-white/60">
          <div className="reveal in">
            ...
            <span className="mx-3 text-white/20">·</span>
            <span>Ақтау, Қазақстан</span>
          </div>
          <div className="hidden md:flex items-center gap-6">
            <span className="text-white/40">2013 — 2026</span>
            <span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse"/> 14 нысан жұмыста</span>
          </div>
        </div>
        ...
        <div className="max-w-[1200px]">
          ...
          <Reveal delay={180}>
            <p className="mt-8 max-w-xl text-[17px] md:text-[19px] leading-[1.55] text-white/75">
              Ақтауда жеке үйлер, коттедждер, мейрамханалар және коммерциялық ғимараттар үшін премиум фасадтық жүйелерді өндіреміз және орнатамыз. Сәулеттік сапа, бір жыл кепілдік.
            </p>
          </Reveal>
          <Reveal delay={260}>
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <Button href="https://wa.me/77022749363" as="a" variant="whatsapp" size="lg" icon={<Icons.WhatsApp size={17}/>} iconAfter={null}>WhatsApp</Button>
...
function TrustStrip() {
  const labels = [
    ...
    'Қазақстан құрылысшылары қауымдастығының мүшесі',
    'Бір жыл кепілдік',
    'Өз өндірісіміз',
    'ISO 9001:2015',
    ...
    <Section className="py-28 md:py-40">
      <Container size="wide">
        <SectionHeader
          ...
          lead="Біз қабырғаны материалмен жабып қана қоймаймыз. Фасадты сәулеттік композицияның бір бөлігі ретінде жобалаймыз — жылутехника, инсоляция және ондаған жылдарға арналған беріктікті есептеп."
        />
  ...
  return (
    <Section className="py-28 md:py-40">
      <Container size="wide">
        <SectionHeader
          align="split"
          eyebrow="ТАҢДАМАЛЫ ЖОБАЛАР"
          title="Фасадтарымыздың каталогы"
          lead="Әрбір нысан — жеке жобалық шешім. Төменде Ақтаудағы соңғы жылдардағы бірнеше жұмыс."
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={80}>
              <h2 className="display text-white text-[clamp(36px,5.4vw,72px)] font-medium leading-[0.96] tracking-tightest">
                Сегіз жыл<br/>бір бағытта —<br/><span className="text-gold-light italic font-light">фасадтар.</span>
              </h2>
            </Reveal>
          </div>
        </div>
  ...
  return (
    <Section tone="mute" className="py-28 md:py-40">
      <Container size="wide">
        <SectionHeader
          align="split"
          eyebrow="ҚАЛАЙ ЖҰМЫС ЖАСАЙМЫЗ"
          title={<>Өтінімнен кепілдікке<br/>дейін ашық процесс</>}
          lead="Әрбір кезең нақты мерзімдермен шартта тіркеледі. Нысанда не болып жатқанын әрқашан білесіз."
          cta={<Button onClick={onOpenConsult} variant="primary" size="md">Кеңесуден бастаңыз</Button>}
        />
            ...
            <Reveal>
              <Card className="p-8 md:p-10 sticky top-28">
                ...
                <div className="space-y-3 pt-6 border-t border-ink-100">
                  {['Мерзімдерді бекітеміз', 'Фотобелгілеу', 'Ашық смета'].map((t, i) => (
  ...
  return (
    <Section className="py-28 md:py-40">
      <Container size="tight">
        ...
        <Reveal delay={80}>
          <h2 className="display text-center text-[clamp(34px,5vw,60px)] font-medium leading-[0.98] tracking-tightest">Тұтынушылар не дейді</h2>
        </Reveal>
        <Reveal delay={160}>
          ...
          <div className="lg:col-span-4">
            ...
            <Reveal delay={160}>
              <p className="mt-6 text-[15.5px] leading-[1.65] text-ink-500">
                Жауап таппадыңыз ба? WhatsApp-қа жазыңыз немесе қоңырау тапсырыңыз — студия сәулетші 15 минут ішінде хабарласады.
              </p>
            </Reveal>
          </div>
  ...
  return (
    <Section className="py-28 md:py-40">
      <Container size="wide">
        <SectionHeader
          align="split"
          eyebrow="@МАНАССТРОЙАКТАУ · INSTAGRAM"
          title={<>Фасадтарымыздың<br/>хроникасы</>}
          lead="Апта сайын нысандардағы процесті, монтаж бөлшектерін және аяқталған жұмыстардың сәулеттік фотосуреттерін көрсетеміз."
          cta={
            <a href="https://www.instagram.com/manas_stroi_aktau/" className="inline-flex items-center gap-3 text-[14px] font-medium tracking-tight hover:text-accent transition-colors">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4">
          {imgs.map((src, i) => (
            <Reveal key={i} delay={i * 60}>
              <a href="https://www.instagram.com/manas_stroi_aktau/" className="block group relative overflow-hidden rounded-2xl" style={{ aspectRatio: '1/1' }}>
...
function MapSection() {
  const points = [
    ...
    { x: 36, y: 72, label: 'пр. Азаттық',     count: 22 },
    ...
    <Section tone="mute" className="py-28 md:py-40 overflow-hidden">
      <Container size="wide">
        <div className="grid lg:grid-cols-12 gap-10 mb-12 items-end">
          <div className="lg:col-span-7">
            <Reveal><Eyebrow className="mb-5">ЖОБАЛАРДЫҢ ГЕОГРАФИЯСЫ</Eyebrow></Reveal>
            <Reveal delay={80}>
              <h2 className="display text-[clamp(34px,5vw,64px)] font-medium leading-[0.98] tracking-tightest">
                5000+ фасад<br/>Ақтау бойынша
              </h2>
            </Reveal>
          </div>
          <div className="lg:col-span-5">
            <Reveal delay={140}>
              <p className="text-[15.5px] leading-[1.65] text-ink-500">
                Нысандарымыздың картасы қаланың барлық аудандары мен қала маңы елді мекендерін қамтиды. Жобалардың басым бөлігі орталықта және сапалы коттедждік аймақтарда шоғырланған.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <div className="relative max-w-2xl">
            ...
            <Reveal delay={80}>
              <h2 className="display text-[clamp(40px,6.4vw,84px)] font-medium leading-[0.96] tracking-tightest">
                Фасад өлшемі<br/><span className="text-gold-light italic font-light">тегін</span>
              </h2>
            </Reveal>
            <Reveal delay={160}>
            ...
            <Reveal delay={320}>
              <div className="mt-12 grid grid-cols-3 gap-6 max-w-xl">
                ...
                <div><Icons.Ruler size={20} className="text-gold-light mb-2"/><div className="text-[13px] text-white/80">Тегін өлшем</div></div>
