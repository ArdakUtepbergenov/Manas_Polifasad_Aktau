            ...
            <div className="lg:col-span-8">
              ...
              <Reveal delay={80}>
                <h1 className="display text-[clamp(48px,7.6vw,128px)] font-medium leading-[0.94] tracking-tightest">
                  Премиум фасадтарға<br/>арналған <span className="text-gold italic font-light">материалдар</span>
                </h1>
              </Reveal>
            </div>
            <div className="lg:col-span-4">
              <Reveal delay={140}>
                <p className="text-[16px] leading-[1.65] text-ink-500">
                  Термопанельдер, сәндік панельдер, жылытылған жүйелер және сәулеттік декор. Барлық позициялар сертификатталған және Ақтау климатына бейімделген.
                </p>
              </Reveal>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="grid grid-cols-2 gap-px bg-ink-100 border border-ink-100 rounded-2xl overflow-hidden mb-8">
              {[
                ...
                { label: 'Ең аз тапсырыс',    value: '8 м²' },
      ...
      <Container size="wide">
        <Card className="p-10 md:p-16 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={80}>
              <h3 className="display text-[clamp(28px,4vw,48px)] font-medium leading-tight tracking-tight">
                Сіздің сәулеттік жобаңызға<br/>сай фасад таңдаймыз.
              </h3>
            </Reveal>
            <Reveal delay={140}>
              <p className="mt-5 text-[15.5px] text-ink-500 max-w-xl leading-[1.65]">
                Тапсырманы айтыңыз — жүйені ұсынып, жылутехниканы есептеп, фасадтың визуализациясын дайындаймыз.
              </p>
            </Reveal>
          </div>
          <div className="lg:col-span-5 flex flex-col gap-3">
            ...
            <Button href="https://wa.me/77022749363" as="a" variant="whatsapp" size="lg" icon={<Icons.WhatsApp size={17}/>} iconAfter={null}>WhatsApp-қа жазу</Button>
          </div>
        </Card>
      </Container>
    </Section>
