            ...
            <div className="lg:col-span-4">
              <Reveal delay={140}>
                <p className="text-[16px] leading-[1.65] text-ink-500">
                  Термопанели, декоративные панели, утеплённые системы и архитектурный декор. Все позиции сертифицированы и адаптированы под климат Ақтау.
                </p>
              </Reveal>
            </div>
          </div>
      ...
      <Container size="wide">
        <Card className="p-10 md:p-16 grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-3">
            ...
            <Button href="https://wa.me/77022749363" as="a" variant="whatsapp" size="lg" icon={<Icons.WhatsApp size={17}/>} iconAfter={null}>Написать в WhatsApp</Button>
          </div>
        </Card>
      </Container>
    </Section>
