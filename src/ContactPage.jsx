          ...
          <div className="grid lg:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="bg-ink-900 text-white rounded-[24px] overflow-hidden relative h-full flex flex-col">
                ...
                <div className="p-8 md:p-10 flex-1 flex flex-col">
                  ...
                  <div className="space-y-5 text-[14.5px]">
                    <ContactLine icon={<Icons.MapPin size={16}/>}   label="Адрес офиса"  value="г. Ақтау, ул. Промышленная зона 9, 8/1"/>
                    <ContactLine icon={<Icons.Building size={16}/>} label="Производство" value="г. Ақтау, ул. Промышленная зона 9, 8/1"/>
            ...
            <Reveal className="lg:col-span-7" delay={120}>
              <div className="h-full flex flex-col gap-4 md:gap-6">
                ...
                <ServiceRow number="02" title="Вызвать замерщика"     text="Бесплатный выезд по Ақтау. Замер фасада, фотофиксация и обсуждение материалов на объекте." cta="Написать в WhatsApp"/>
          ...
          <Reveal>
            <div className="relative rounded-[28px] overflow-hidden border border-ink-200 bg-white" style={{ aspectRatio: '21/9' }}>
              ...
              <div className="absolute top-6 left-6 bg-white rounded-2xl border border-ink-200 shadow-soft p-5 max-w-xs">
                ...
                <div className="text-[13px] text-ink-500 leading-relaxed">ул. Промышленная зона 9, 8/1<br/>г. Ақтау, Казахстан</div>
      ...
      <Section className="py-20 md:py-28 bg-white">
        <Container size="wide">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <QuickInfo icon="Ruler"  title="Замер фасада"           text="Бесплатно в Ақтау. Для объектов от 200 м² — выезд по Ақтауской области."/>
