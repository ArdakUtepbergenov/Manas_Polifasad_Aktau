            ...
            <div className="lg:col-span-8">
              ...
              <Reveal delay={80}>
                <h1 className="display text-[clamp(48px,7.6vw,128px)] font-medium leading-[0.94] tracking-tightest">
                  Келіп <span className="text-gold italic font-light">сөйлесейік</span>
                </h1>
              </Reveal>
            </div>
            <div className="lg:col-span-4">
              <Reveal delay={140}>
                <p className="text-[16px] leading-[1.65] text-ink-500">
                  WhatsApp-тағы орташа жауап уақыты — 7 минут. Студия сәулетші ыңғайлы визит уақытын келіседі және фасадтың есебін дайындайды.
                </p>
              </Reveal>
            </div>
          </div>
              ...
              <div className="relative p-10 md:p-16 grid lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-8">
                  ...
                  <h2 className="display text-[clamp(36px,5.6vw,76px)] font-medium leading-[0.96] tracking-tightest mb-6">
                    Бізге WhatsApp-та<br/>жазыңыз
                  </h2>
                  <p className="text-[17px] leading-[1.6] text-white/85 max-w-xl">
                    Барлық кеңестер, өлшемдер және есептеулер — WhatsApp арқылы. Бұл жылдамырақ: нысанның фотосуреттерін, өлшемдерін, эталондарды бірден жіберуге болады.
                  </p>
                ...
                <div className="lg:col-span-4 grid grid-cols-3 lg:grid-cols-1 gap-3 text-white">
                  ...
                  <WAstat label="Қолжетімді"   value="Дс — Сб"/>
                  <WAstat label="Сағаттар"      value="09:00 — 18:00"/>
                </div>
              </div>
            </a>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="bg-ink-900 text-white rounded-[24px] overflow-hidden relative h-full flex flex-col">
                ...
                <div className="p-8 md:p-10 flex-1 flex flex-col">
                  ...
                  <h3 className="display text-[28px] md:text-[32px] font-medium tracking-tight leading-tight mb-6">
                    Ақтау, ул. Промышленная зона 9, 8/1
                  </h3>
                  <div className="space-y-5 text-[14.5px]">
                    <ContactLine icon={<Icons.MapPin size={16}/>}   label="Кеңсенің мекенжайы"  value="г. Ақтау, ул. Промышленная зона 9, 8/1"/>
                    <ContactLine icon={<Icons.Building size={16}/>} label="Өндіріс"              value="г. Ақтау, ул. Промышленная зона 9, 8/1"/>
                    <ContactLine icon={<Icons.Clock size={16}/>}    label="Жұмыс уақыты"        value="Дс — Сб · 09:00 — 18:00"/>
                  ...
                  <div className="mt-auto pt-8 grid grid-cols-2 gap-3">
                    ...
                    <Button href="tel:+77022749363" as="a" variant="invert_dark" size="md" icon={<Icons.Phone size={15}/>} iconAfter={null}>Қоңырау</Button>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal className="lg:col-span-7" delay={120}>
              <div className="h-full flex flex-col gap-4 md:gap-6">
                <ServiceRow number="01" title="Кеңес алу"          text="Студия сәулетші фасадтық жүйелер, материалдар және мерзімдер туралы сұрақтарға жауап береді." cta="WhatsApp-қа жазу"/>
                <ServiceRow number="02" title="Өлшеуші шақыру"    text="Ақтауда тегін шығу. Фасадты өлшеу, фотобелгілеу және нысандағы материалдарды талқылау." cta="WhatsApp-қа жазу"/>
                <ServiceRow number="03" title="Құнын есептеу"     text="Материалдар мен жұмыстар бойынша егжей-тегжейлі ашық смета 3 жұмыс күні ішінде." cta="WhatsApp-қа жазу"/>
                <ServiceRow number="04" title="Фасад жобасы"      text="Материалдарды таңдаумен визуализациясы бар сәулеттік жоба. 7 жұмыс күнінен бастап." cta="WhatsApp-қа жазу"/>
              </div>
            </Reveal>
          </div>
        </Container>
          ...
          <Reveal>
            <div className="relative rounded-[28px] overflow-hidden border border-ink-200 bg-white" style={{ aspectRatio: '21/9' }}>
              ...
              <div className="absolute top-6 left-6 bg-white rounded-2xl border border-ink-200 shadow-soft p-5 max-w-xs">
                ...
                <div className="text-[13px] text-ink-500 leading-relaxed">ул. Промышленная зона 9, 8/1<br/>Ақтау қ., Қазақстан</div>
      ...
      <Section className="py-20 md:py-28 bg-white">
        <Container size="wide">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <QuickInfo icon="Ruler"  title="Фасад өлшемі"          text="Ақтауда тегін. 200 м²-ден астам нысандар үшін — Ақтау облысы бойынша шығу."/>
            <QuickInfo icon="Shield" title="Міндеттемесіз"          text="Кеңес беру және құнын есептеу қаржылық міндеттемелер туғызбайды."/>
          </div>
        </Container>
      </Section>
    </div>
