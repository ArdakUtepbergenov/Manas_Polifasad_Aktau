            ...
            <div className="lg:col-span-4">
              <Reveal delay={140}>
                <p className="text-[16px] leading-[1.65] text-ink-500">
                  Студияның 2013 жылдан бастапқы жобаларының мұрағаттық жинағы. Сәулеттік фотосурет, материалдардың сипаттамасы және әрбір нысанның тарихы.
                </p>
              </Reveal>
            </div>
          </div>
            ...
            <div className="lg:col-span-7">
              ...
              <Reveal delay={80}>
                <h3 className="display text-[clamp(28px,4vw,48px)] font-medium leading-tight tracking-tight">
                  Биыл сіздің фасадыңызды<br/>осы галереяға қосамыз.
                </h3>
              </Reveal>
            </div>
      ...
      <div className="relative w-full max-w-7xl max-h-[88vh] bg-white rounded-[24px] overflow-hidden grid lg:grid-cols-12 shadow-soft-lg">
        ...
        <div className="lg:col-span-4 p-8 md:p-10 overflow-y-auto max-h-[88vh]">
          ...
          <div className="mt-8 grid gap-2">
            <Button onClick={() => { onClose(); onOpenConsult(); }} variant="primary" size="md">Осындай фасад қалаймын</Button>
            <Button href="https://wa.me/77022749363" as="a" variant="outline" size="md" icon={<Icons.WhatsApp size={15}/>} iconAfter={null}>WhatsApp-та талқылау</Button>
          </div>
        </div>
      </div>
    </div>
